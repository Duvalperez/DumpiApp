...
export default class cl_vEstadisticas extends Cl_vGeneral {
    ...
    public renderizarEstructuraInicial() {
     ...
     */
    public actualizarEstadisticas(datos: {
        saldoInicial: number;
        totalIngresos: number;
        totalEgresos: number;
        saldoFinal: number; // Suma y resta de Ingresos y Egresos
        desglose: { [key: string]: { totalAbonos: number; totalCargos: number; diferencial: number } };
    }) {
    ...
    private asignarValor(id: string, valor: number) {
    ...
    private renderizarDesglose(desglose: any) {
